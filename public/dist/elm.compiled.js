...
var $author$project$Generated$Pages$Guide_Folder_Model = function (a) {
	return {$: 'Guide_Folder_Model', a: a};
};
var $author$project$Generated$Pages$Guide_Folder_Msg = function (a) {
	return {$: 'Guide_Folder_Msg', a: a};
};
...
var $author$project$Generated$Guide$Route$Dynamic = F2(
	function (a, b) {
		return {$: 'Dynamic', a: a, b: b};
	});
...
var $author$project$Generated$Route$Guide_Folder = function (a) {
	return {$: 'Guide_Folder', a: a};
};
...
var $author$project$Generated$Routes$routes = {
	...
	guide: $author$project$Generated$Route$Guide(
		{}),
	guide_dynamic: function (param1) {
		return $author$project$Generated$Route$Guide_Folder(
			A2(
				$author$project$Generated$Guide$Route$Dynamic,
				param1,
				{param1: param1}));
	},
...
var $author$project$Generated$Guide$Route$toPath = function (route) {
	var value = route.a;
	return '/' + value;
};
var $author$project$Generated$Route$toPath = function (route) {
	switch (route.$) {
		...
		default:
			var subRoute = route.a;
			return '/guide' + $author$project$Generated$Guide$Route$toPath(subRoute);
	}
};
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$map,
						function (prop) {
							return prop + (' ' + ($elm$core$String$fromInt(duration) + 'ms ease-in-out'));
						},
						properties))));
	});
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.underline);
var $author$project$Ui$viewLink = F2(
	function (activeRoute, _v0) {
		var label = _v0.a;
		var route = _v0.b;
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						['opacity'])),
					_Utils_eq(activeRoute, route) ? $mdgriffith$elm_ui$Element$alpha(0.5) : $mdgriffith$elm_ui$Element$alpha(1.0)
				]),
			{
...
var $author$project$Ui$viewLinks = F2(
	function (route, links) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				$author$project$Ui$viewLink(route),
				links));
	});
var $author$project$Ui$viewSectionHeader = function (label) {
	return A2(
...
var $author$project$Ui$sidebar = function (options) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text(options.header)),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
						...
						[
							...
							function (link) {
								return A2(
									...
									A2($author$project$Ui$viewLink, options.active, link));
							},
							options.links),
							A2(
							$elm$core$List$map,
							function (section) {
								return A2(
									...
									_List_fromArray(
										[
											$author$project$Ui$viewSectionHeader(section.header),
											A2($author$project$Ui$viewLinks, options.active, section.links)
										]));
							},
							options.sections)
						])))
...
var $author$project$Layouts$Docs$viewSidebar = function (route) {
	return $author$project$Ui$sidebar(
		{
			active: route,
			header: 'docs',
			links: _List_fromArray(
				[
					_Utils_Tuple2('overview', $author$project$Generated$Routes$routes.docs_top)
				]),
				...
				[
					...
					links: _List_fromArray(
						[
							_Utils_Tuple2(
							'overview',
							$author$project$Generated$Routes$routes.docs_dynamic('elm-spa')),
							_Utils_Tuple2(
							'elm-spa init',
							A2($author$project$Generated$Routes$routes.docs_dynamic_dynamic, 'elm-spa', 'init')),
							_Utils_Tuple2(
							'elm-spa add',
							A2($author$project$Generated$Routes$routes.docs_dynamic_dynamic, 'elm-spa', 'add')),
							_Utils_Tuple2(
							'elm-spa build',
							A2($author$project$Generated$Routes$routes.docs_dynamic_dynamic, 'elm-spa', 'build'))
						])
				},
					{
					header: 'pages',
					links: _List_fromArray(
						[
							_Utils_Tuple2(
							'overview',
							$author$project$Generated$Routes$routes.docs_dynamic('pages')),
							_Utils_Tuple2(
							'static',
							A2($author$project$Generated$Routes$routes.docs_dynamic_dynamic, 'pages', 'static')),
							_Utils_Tuple2(
							'sandbox',
							A2($author$project$Generated$Routes$routes.docs_dynamic_dynamic, 'pages', 'sandbox')),
							_Utils_Tuple2(
							'element',
							A2($author$project$Generated$Routes$routes.docs_dynamic_dynamic, 'pages', 'element')),
							_Utils_Tuple2(
							'component',
							A2($author$project$Generated$Routes$routes.docs_dynamic_dynamic, 'pages', 'component'))
						])
				}
				])
		});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{bottom: 128, left: 16, right: 16, top: 48})
			]),
		_List_fromArray(
			[
				A2(
				...
				$author$project$Layouts$Docs$viewSidebar(route)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
...
var $author$project$Generated$Guide$Pages$DynamicModel = function (a) {
	return {$: 'DynamicModel', a: a};
};
var $author$project$Generated$Guide$Pages$DynamicMsg = function (a) {
	return {$: 'DynamicMsg', a: a};
};
var $author$project$Pages$Guide$Dynamic$FetchedContent = function (a) {
	return {$: 'FetchedContent', a: a};
};
var $author$project$Pages$Guide$Dynamic$init = function (_v0) {
	var param1 = _v0.param1;
	return _Utils_Tuple2(
		{content: ''},
		$elm$http$Http$get(
			{
				expect: $elm$http$Http$expectString($author$project$Pages$Guide$Dynamic$FetchedContent),
				url: '/content/guide/' + (param1 + '.md')
			}));
};
var $author$project$Pages$Guide$Dynamic$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$Guide$Dynamic$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Ok') {
			var markdown = msg.a.a;
			return _Utils_Tuple2(
...
var $author$project$Pages$Guide$Dynamic$view = function (model) {
	return $author$project$Ui$markdown(model.content);
};
var $author$project$Pages$Guide$Dynamic$page = $ryannhg$elm_spa$Spa$Page$element(
	{
		init: $elm$core$Basics$always($author$project$Pages$Guide$Dynamic$init),
		subscriptions: $elm$core$Basics$always($author$project$Pages$Guide$Dynamic$subscriptions),
		title: $elm$core$Basics$always('Guide.Dynamic'),
		update: $elm$core$Basics$always($author$project$Pages$Guide$Dynamic$update),
		view: $elm$core$Basics$always($author$project$Pages$Guide$Dynamic$view)
	});
var $author$project$Generated$Guide$Pages$recipes = {
	dynamic: $author$project$Utils$Spa$recipe(
		{page: $author$project$Pages$Guide$Dynamic$page, toModel: $author$project$Generated$Guide$Pages$DynamicModel, toMsg: $author$project$Generated$Guide$Pages$DynamicMsg})
};
var $author$project$Generated$Guide$Pages$bundle = function (bigModel) {
	var model = bigModel.a;
	return $author$project$Generated$Guide$Pages$recipes.dynamic.bundle(model);
};
var $author$project$Generated$Guide$Pages$init = function (route_) {
	var params = route_.b;
	return $author$project$Generated$Guide$Pages$recipes.dynamic.init(params);
};
var $author$project$Generated$Guide$Pages$path = _List_fromArray(
	[
		$ryannhg$elm_spa$Spa$Path$static('guide')
	]);
var $author$project$Generated$Guide$Pages$update = F2(
	function (bigMsg, bigModel) {
		var _v0 = _Utils_Tuple2(bigMsg, bigModel);
		var msg = _v0.a.a;
		var model = _v0.b.a;
		return A2($author$project$Generated$Guide$Pages$recipes.dynamic.update, msg, model);
	});
var $author$project$Layouts$Guide$viewSidebar = function (route) {
	return $author$project$Ui$sidebar(
		{
			active: route,
			header: 'guide',
			links: _List_fromArray(
				[
					_Utils_Tuple2(
					'installation',
					$author$project$Generated$Routes$routes.guide_dynamic('installation')),
					_Utils_Tuple2(
					'getting-started',
					$author$project$Generated$Routes$routes.guide_dynamic('getting-started'))
				]),
			sections: _List_Nil
		});
};
var $author$project$Layouts$Guide$view = function (_v0) {
	var page = _v0.page;
	var route = _v0.route;
	return A2(
		$mdgriffith$elm_ui$Element$row,
		...
		_List_fromArray(
			[
				...
				$author$project$Layouts$Guide$viewSidebar(route)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
...
var $author$project$Generated$Guide$Pages$page = $author$project$Utils$Spa$layout(
	{
		path: $author$project$Generated$Guide$Pages$path,
		recipe: {bundle: $author$project$Generated$Guide$Pages$bundle, init: $author$project$Generated$Guide$Pages$init, update: $author$project$Generated$Guide$Pages$update},
		view: $author$project$Layouts$Guide$view
	});
...
var $author$project$Ui$button = function (_v0) {
	var label = _v0.a;
	var url = _v0.b;
	return A2(
		$mdgriffith$elm_ui$Element$link,
		...
		A2(
			...
			$elm$core$List$isEmpty(options.buttons) ? _List_Nil : _List_fromArray(
				[
					...
					A2($elm$core$List$map, $author$project$Ui$button, options.buttons))
				])));
};
		...
		[
			$author$project$Ui$hero(
			{
				buttons: _List_fromArray(
					[
						_Utils_Tuple2('getting started', '/guide/getting-started')
					]),
...
var $author$project$Pages$Top$view = $author$project$Ui$hero(
	{
		buttons: _List_fromArray(
			[
...
var $author$project$Generated$Pages$recipes = {
	...
	guide_folder: $author$project$Utils$Spa$recipe(
		{page: $author$project$Generated$Guide$Pages$page, toModel: $author$project$Generated$Pages$Guide_Folder_Model, toMsg: $author$project$Generated$Pages$Guide_Folder_Msg}),
...
var $author$project$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		...
		default:
			var model = bigModel.a;
			return $author$project$Generated$Pages$recipes.guide_folder.bundle(model);
	}
};
var $author$project$Generated$Pages$init = function (route_) {
	switch (route_.$) {
		...
		default:
			var route = route_.a;
			return $author$project$Generated$Pages$recipes.guide_folder.init(route);
	}
};
	...
	function (bigMsg, bigModel) {
		...
		while (true) {
			switch (_v0.a.$) {
				...
				default:
					if (_v0.b.$ === 'Guide_Folder_Model') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Generated$Pages$recipes.guide_folder.update, msg, model);
					} else {
						break _v0$5;
					}
			}
...
var $author$project$Layout$viewFooter = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width(
			A2($mdgriffith$elm_ui$Element$maximum, 720, $mdgriffith$elm_ui$Element$fill)),
			$mdgriffith$elm_ui$Element$centerX,
			A2($mdgriffith$elm_ui$Element$paddingXY, 16, 48),
			$mdgriffith$elm_ui$Element$Font$size(16),
			$mdgriffith$elm_ui$Element$alpha(0.5)
		]),
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('this site was built with elm-spa!'),
			A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					{
						label: $mdgriffith$elm_ui$Element$text('the elm package'),
		...
		_List_fromArray(
			[
				...
				$author$project$Ui$button(
					_Utils_Tuple2('get started', '/guide')))
			]));
};
	...
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						{name: 'Source Sans Pro', url: 'https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600'}),
		...
		_List_fromArray(
			[
				...
				page,
				$author$project$Layout$viewFooter
			]));
};
...
var $author$project$Generated$Routes$parsers = _List_fromArray(
	[
		...
		A2(
		$elm$url$Url$Parser$map,
		$author$project$Generated$Routes$routes.guide_dynamic,
		A2(
			$elm$url$Url$Parser$slash,
			$elm$url$Url$Parser$s('guide'),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Spa.Msg Global.Msg Generated.Pages.Msg","aliases":{"Pages.Guide.Msg":{"args":[],"type":"Basics.Never"},"Pages.NotFound.Msg":{"args":[],"type":"Basics.Never"},"Pages.Top.Msg":{"args":[],"type":"Basics.Never"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Generated.Pages.Msg":{"args":[],"tags":{"GuideMsg":["Pages.Guide.Msg"],"NotFoundMsg":["Pages.NotFound.Msg"],"TopMsg":["Pages.Top.Msg"],"Docs_Folder_Msg":["Generated.Docs.Pages.Msg"],"Guide_Folder_Msg":["Generated.Guide.Pages.Msg"]}},"Global.Msg":{"args":[],"tags":{"Msg":[]}},"Spa.Msg":{"args":["globalMsg","msg"],"tags":{"ChangedUrl":["Url.Url"],"ClickedLink":["Browser.UrlRequest"],"Global":["globalMsg"],"Page":["msg"],"FadeInLayout":[],"FadeInPage":["Url.Url"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Generated.Docs.Pages.Msg":{"args":[],"tags":{"DynamicMsg":["Pages.Docs.Dynamic.Msg"],"TopMsg":["Pages.Docs.Top.Msg"],"Dynamic_Folder_Msg":["Generated.Docs.Dynamic.Pages.Msg"]}},"Generated.Guide.Pages.Msg":{"args":[],"tags":{"DynamicMsg":["Pages.Guide.Dynamic.Msg"]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Generated.Docs.Dynamic.Pages.Msg":{"args":[],"tags":{"DynamicMsg":["Pages.Docs.Dynamic.Dynamic.Msg"]}},"Pages.Docs.Dynamic.Msg":{"args":[],"tags":{"FetchedContent":["Result.Result Http.Error String.String"]}},"Pages.Docs.Top.Msg":{"args":[],"tags":{"FetchedContent":["Result.Result Http.Error String.String"]}},"Pages.Guide.Dynamic.Msg":{"args":[],"tags":{"FetchedContent":["Result.Result Http.Error String.String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Pages.Docs.Dynamic.Dynamic.Msg":{"args":[],"tags":{"FetchedContent":["Result.Result Http.Error String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}}}})}});}(this));